...
if Config.vRP then
    ...
    RegisterNetEvent("vrp_version:r-hud:GetStatus")
    AddEventHandler("vrp_version:r-hud:GetStatus", function()
        local user_id = vRP.getUserId({ source })
        TriggerClientEvent("vrp_version:r-hud:GetStatus:return", source,
            {
